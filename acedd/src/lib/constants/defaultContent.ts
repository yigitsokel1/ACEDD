...
export const DEFAULT_PAGE_CONTENT: Record<string, PageContent> = {
  ...
  about: {
    ...
    organizationStructureDescription: "Derneğimiz, eşitlikçi ve işbirlikçi bir yapıda organize edilmiş olup, her birim kendi sorumluluk alanında etkin bir şekilde çalışmaktadır. Bu yapı sayesinde eğitim destek faaliyetlerimizi daha verimli ve koordineli bir şekilde yürütmekteyiz.",
  },
