...
export const MISSION_DATA: MissionCard[] = [
  {
    ...
    title: 'Burs Vermek',
    description: 'Maddi imkanları kısıtlı ancak başarılı öğrencilere, özellikle de üniversite öğrencilerine burslar vererek eğitimlerini sürdürmelerine destek oluyoruz.',
    color: 'blue'
  },
  {
    ...
    description: 'Yaz kampları, kariyer seminerleri, kültürel geziler ve sanat etkinlikleri düzenleyerek öğrencilerin kişisel gelişimlerine katkı sağlıyoruz.',
    color: 'amber'
  },
  {
    ...
    description: 'İş adamları, bilim adamları, yöneticiler, öğretmenler ve sanatçıları bir araya getirerek eğitim konusunda fikir alışverişi yapmalarını teşvik ediyoruz.',
    color: 'emerald'
  },
  {
    id: 'farkindalik',
    ...
    description: '"Parasızlık yüzünden okuyamadım" diyen hiçbir öğrencinin kalmaması için eğitimde fırsat eşitliği konusunda toplumsal farkındalık oluşturuyoruz.',
    color: 'rose'
  }
];
